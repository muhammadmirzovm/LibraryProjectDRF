...
class BookDetailAPIView(APIView):
    def get(self, request, pk):
        try:
            book = Book.objects.get(id=pk)  # ✅ use .get(), not .all()
            ...
            return Response(data, status=status.HTTP_200_OK)  # ✅ success code
        except Book.DoesNotExist:  # ✅ handle only Book not found
            return Response(
                {
